...
CELERY_WORKER_CONCURRENCY = _get_int("CELERY_WORKER_CONCURRENCY", 1)
CELERY_TASK_SOFT_TIME_LIMIT = _get_int("CELERY_TASK_SOFT_TIME_LIMIT", 1800)
CELERY_TASK_TIME_LIMIT = _get_int("CELERY_TASK_TIME_LIMIT", 2100)
...
MAX_BATCH_TOTAL_SIZE_MB = _get_int("MAX_BATCH_TOTAL_SIZE_MB", 4096)
MAX_VIDEO_DURATION_MINUTES = _get_int("MAX_VIDEO_DURATION_MINUTES", 180)
MAX_PARALLEL_SEGMENTS = _get_int("MAX_PARALLEL_SEGMENTS", 60)
...
OLLAMA_CAPABILITY_CACHE_TTL_SECONDS = _get_non_negative_int("OLLAMA_CAPABILITY_CACHE_TTL_SECONDS", 15)
...
REPORT_EXPORT_TIMEOUT_SECONDS = _get_int("REPORT_EXPORT_TIMEOUT_SECONDS", 120)
SUBTITLE_FONT_NAME = (_getenv("SUBTITLE_FONT_NAME", "Noto Sans CJK TC") or "Noto Sans CJK TC").strip()
...
DOWNLOAD_TICKET_TTL_SECONDS = _get_int("DOWNLOAD_TICKET_TTL_SECONDS", 120)
